...
class EnsembleModel(nn.Module):
    ...
    def train(self, loss):
        ...
        loss += .01 * torch.sum(self._max_logvar) - .01 * torch.sum(self._min_logvar)
        loss.backward()
        self.optimizer.step()
...
class EnsembleDynamicsModel:
    ...
    def train(self, inputs, labels, batch_size=64, holdout_ratio=.1, max_iter=20):
    ...
    def _save_best(self, epoch, losses, threshold=.1):
        updated = False
        ...
        return self._epoch_since_last_update
